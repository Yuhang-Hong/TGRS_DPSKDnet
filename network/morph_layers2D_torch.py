...
class Morphology(nn.Module):
    ...
    def forward(self, x):
        ...
        # unfold
        # (B, Cin*kH*kW, L), where L is the numbers of patches
        x = self.unfold(x)
        ...
        x = x.view(-1, self.out_channels, L_sqrt,
                   L_sqrt)  # (B, Cout, L/2, L/2)
